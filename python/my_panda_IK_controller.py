...
class myPandaIKController:
    ...
    def __init__(self, bullet_data_path="../robosuite/robosuite/models/assets/bullet_data/", robot_jpos_getter=None, robot_jvel_getter=None):
        """
        Args:
        ...
        self.robot_jvel_getter = robot_jvel_getter
    ...
    def get_qpos(self, eef_pos, rotation):
        """
        ...
        self.commanded_joint_positions = self.eef_pos_orn_2_joint_pos(
            eef_pos, rotation
        )
        return self.commanded_joint_positions
        # torques = controllers.PDControl(q=self.robot_jpos_getter(), qd=self.robot_jvel_getter(), qgoal=self.commanded_joint_positions)
        # return torques
