...
class myPandaFreeSpaceTraj(superclass, gym.Env):
    ...
    def __init__(self, has_renderer=False):
        ...
        PandaFreeSpaceTraj.__init__(self, has_renderer=False, has_offscreen_renderer=False, use_camera_obs=False)
        # self.spec = mySpec()
    ...
    def step(self, action):
        ...
        # print("timestep:{} horizon:{}".format(self.timestep, self.horizon))
